...
public class BoardController {
    ...
    public BoardController (){
        ...
        fields[5] = new GUI_Street("Iskiosk", "1 M","Du er landet på Iskiosken","1 M",Color.darkGray, Color.BLACK);
        ...
        fields[7] = new GUI_Street("Museet" , " 2 M ", " Du er landet på Museet " , " 2 M " , Color.YELLOW , Color.BLACK );
        ...
        fields[11] = new GUI_Street("Svømmingpoolen" , " 2 M " , " Plask, du faldt i bassinet " , " 2 M " , Color.GREEN , Color.BLACK );
        ...
        fields[14] = new GUI_Street("Biografen" , " 3 M " , " Du er landet på Biografen " , " 3 M " , Color.LIGHT_GRAY, Color.BLACK);
        ...
        fields[17] = new GUI_Street("Dyrehandlen", "3 M", "Du landede på Dyrehandlen", "3", Color.WHITE, Color.BLACK);
        ...
        fields[19] = new GUI_Street("Bowlinghallen", "4 M", "Du landede på Bowlinghallen", "4", Color.magenta, Color.BLACK);
        fields[20] = new GUI_Street("Zoologisk Have", "4 M", "Du landede Zoologisk Have", "4", Color.GREEN, Color.BLACK);
        fields[21] = new GUI_Chance();
        fields[22] = new GUI_Street("Vandlandet", "5 M", "Du landede på Vandlandet", "5", Color.cyan, Color.orange);
